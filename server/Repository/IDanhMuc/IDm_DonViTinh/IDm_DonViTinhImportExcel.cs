...
namespace server.Repository.IDanhMuc.IDm_DonViTinh
{
    public interface IDm_DonViTinhImportExcel
    {
        ...
        Task<ImportResultDto> ImportFromExcelAsync(IFormFile file, IDbTransaction transaction = null);
        ...
        Task<List<ImportErrorDto>> ValidateBatchAsync(
        ...
        Task<int> SaveBatchAsync(List<Dm_DonViTinh> validData, IDbTransaction transaction = null);
    }
}
